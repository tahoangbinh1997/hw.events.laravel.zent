		...
		<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
			<form action="{{ route('events.update',$id) }}" method="POST" role="form">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="content" id="content" placeholder="Content" value="{{$event->content}}">
				</div>
				<div class="form-group"> <!-- Date input -->
					<label for="">Time</label>
					<input class="form-control" id="time" name="time" placeholder="MM/DD/YYY" type="text" value="{{$event->time}}"/>
				</div>
				<div class="form-group">
